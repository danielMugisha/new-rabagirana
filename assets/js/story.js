...
window.onload = () => {
    ...
    var story = myStories.find((st) => st.id == id);
    document.getElementById("story-title").innerText=story.title;
    document.getElementById("story-body").innerText=story.content;
    var image_el = document.getElementById("story-image");
    image_el.src = story.image;
    buildStories();
};

const buildStories = () => {
    var otherStories = document.getElementById("other-stories");
    otherStories.innerHTML = "";
    myStories.forEach(story=>{
        otherStories.innerHTML+=`
    <div class="col col-12 col-md-6 col-xl-4 p-0">
    <div class="relative flex flex-col m-25 shadow-md">
      <a href="#contact-modal" data-lity="#contact-modal"
        ><img
      ...
      >
        <div
          class="ld-fancy-heading relative mb-10 bg-gray-200 rounded-100"
        >
          <h6
            class="ld-fh-element relative py-5 px-10 mb0/5em text-12 leading-0"
          >
            ${story.narrator}
          </h6>
        </div>
        ...
        <a
          ...
          class="button btn ws-nowrap btn-naked btn-icon-right btn-has-label text-15 font-bold text-secondary"
          ><span
            class="btn-txt"
            >Read More</span
          >
